...
public class PageMakerVo_e {
    ...
    private Criteria_e cri;
    
    /* 생성자 */
    public PageMakerVo_e(Criteria_e cri, int total) {
	...
	public Criteria_e getCri() {
		return cri;
	}

	public void setCri(Criteria_e cri) {
		this.cri = cri;
	}
