...
public class PageMakerVo_re {
    ...
    private Criteria_re cri;
    
    /* 생성자 */
    public PageMakerVo_re(Criteria_re cri, int total) {
	...
	public Criteria_re getCri() {
		return cri;
	}

	public void setCri(Criteria_re cri) {
		this.cri = cri;
	}
