...
@Service("e_write")
public class EventWriteService implements EventService {

	private EventDao eventDao;
	
	@Autowired(required=false)
	public EventWriteService(EventDao eventDao) {
		this.eventDao = eventDao;
	}
	
	
	@Override
	public int eventWrite(EventVo eventVo, MultipartRequest uploadFile, HttpServletRequest request) {
