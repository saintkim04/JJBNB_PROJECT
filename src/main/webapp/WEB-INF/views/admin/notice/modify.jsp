...
<body>
	...
	<main class="container main-box">
		...
		<section class="content-notice">
			<form action="${pageContext.request.contextPath}/notice/notice_modify_process.do?n_idx=${noticeVo.n_idx}" method="post" id="notice_modify">
				<div class="content-list">
					...
					<ul>
						<li>
							...
							<input type="text" id="questionTitle" class="text_type_1" value="${noticeVo.n_title}" name="n_title" placeholder="제목을 작성해주세요."/>
						</li>
					</ul>
					...
					<ul>
						<section class="text_wrap">
							<p>공지 내용</p>
								<div>
									<textarea name="n_content" id="questionTextarea" placeholder="공지하실 내용을 10자 이상 입력해 주세요.">${noticeVo.n_content}
</textarea>
								</div>
						</section>
					</ul>
				...
				<button id="write_ok" class="btn_red_fill" type="submit" onclick="">수정 완료</button>				
			</form>
		</section>
	</main>
