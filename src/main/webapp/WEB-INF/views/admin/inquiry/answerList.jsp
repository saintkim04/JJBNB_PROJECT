...
<body>
		...
		<section class="content">
			<div class="content-list">
				<ul class="content-list-tap">
					<li><a href="${pageContext.request.contextPath}/inquiry/admin/inquiry_list.do"><h6>답변 대기중인 내역&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6></a></li>
					<li><a href="${pageContext.request.contextPath}/inquiry/admin/inquiry_answer_list.do"><h6><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;답변완료 내역</h6></span></a></li>
				</ul>
				<hr>
				...
				<div class="list_none1" style="display: block;">
					<c:choose>
						<c:when test="${empty answerList}">
							<ul>
								<li><p><strong>답변이 완료된 내역이 없습니다.</strong></p></li>
							</ul>
						</c:when>
						...
						<c:otherwise>
							<ul class="content-list-show comment a">
								<li>
									<c:forEach var="inquiryVo" items="${answerList}">
    ...
    <script type="text/javascript">
		...
		$(".pagination a").on("click", function(e){
			...
			moveForm1.attr("action", "${pageContext.request.contextPath}/inquiry/admin/inquiry_answer_list.do");
			moveForm1.submit();
