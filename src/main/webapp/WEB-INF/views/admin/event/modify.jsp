    	...
    	$(document).ready(function(){
    		$("#btn_ok").click(function(){
    			...
    			if(title == ""){
    				...
    				$("#file").focus();
    				return false;
    			}else if(confirm("이벤트 내용을 수정하시겠습니까?")){
    				$("#regform").submit();
    			}else{
    				return false
    			}
...
<body>
	...
	<main class="container main-box">
		...
		<section class="content-notice">
			<form id="regform" class="e_regform" action="${pageContext.request.contextPath}/event/event_modify_process.do?e_idx=${eventVo.e_idx}" method="post" enctype="multipart/form-data">
			<input type="hidden" name="m_idx" value="${m_idx}"/>
				<div class="content-list">
					<ul>
						<li>
							...
							<input type="text" class="text_type_1" id="title" name="e_title" value="${eventVo.e_title}" placeholder="제목을 작성해주세요."/>
						</li>
						<li>
							<section class="text_wrap">
								<p>이벤트 기간</p>
							...
							<input type="text" class="text_type_2 btn-1" name="e_sdate" value="${eventVo.e_sdate}"/>
							<input type="text" class="text_type_2 btn-1" name="e_edate" value="${eventVo.e_edate}"/>
						</li>
					</ul>
				...
				<button id="btn_ok" class="btn_red_fill" type="submit" onclick="">수정 완료</button>
			</form>
		</section>
	</main>
