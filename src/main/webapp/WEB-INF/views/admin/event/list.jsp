...
<body>
		...
		<section class="content">
			<div class="content-list">
				<ul class="content-list-show">
					<li><h2>이벤트 관리</h2></li>
					<li class="btn_event_insert">
						<a href="${pageContext.request.contextPath}/event/admin/event_write.do">
							...
							<c:otherwise>
								...
								<c:forEach var="eventVo" items="${eventList}">
										<div class="content-event">
											...
											<p><strong>${eventVo.e_title}</strong></p>
											<span>기간: ${eventVo.e_sdate} ~ ${eventVo.e_edate}</span>
											
							
										</div>
							  
                            			 <a href="${pageContext.request.contextPath}/event/event_view.do?e_idx=${eventVo.e_idx}">
                            			 	<img src="${pageContext.request.contextPath}/resources/upload/s_${eventVo.origin_filename1}" style="width:600px; height: 200px;">
                            			 </a>
							
										<br><br>
										
										<div class="event-delete">
											<a href="${pageContext.request.contextPath}/event/event_delete_process.do?e_idx=${eventVo.e_idx}" onclick='return confirm("이벤트를 삭제하시겠습니까?")'>
    ...
    <script>
		...
		$(".pagination a").on("click", function(e){
			...
			moveForm1.attr("action", "${pageContext.request.contextPath}/event/admin/event_list.do");
			moveForm1.submit();
