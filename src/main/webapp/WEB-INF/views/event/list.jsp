...
<body>
	...
	<main class="container main-box">
		 ...
		 <nav class="side-nav">
			<dl class="side-nav-title">
				...
				<dd><a href="${pageContext.request.contextPath}/event/event_list.do"><span>이벤트</span></a></dd>
		...
		<section class="content">
			<div class="content-list">
				...
				<c:choose>
				<c:when test="${memberVo.m_grade == 2}">
					<a href="${pageContext.request.contextPath}/event/admin/event_list.do">
	...
	<script>
		...
		$(".pagination a").on("click", function(e){
			...
			moveForm1.attr("action", "${pageContext.request.contextPath}/event/event_list.do");
			moveForm1.submit();
