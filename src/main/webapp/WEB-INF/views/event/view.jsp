...
<%@include file="/resources/include/fix-header.jsp" %>
	...
	<main class="container main-box">
		...
		<section class="content e_img">
			<img src="${pageContext.request.contextPath}/resources/upload${eventVo.origin_filename2}">
			<a href="${pageContext.request.contextPath}/event/event_list.do">
				<button class="btn_red_fill" onclick="" style="margin-top: 50px;">목록으로</button>
			</a>
